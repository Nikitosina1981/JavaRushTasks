...
public class HHStrategy implements Strategy
{
    ...
    // private String f = String.format(URL_FORMAT,"Kiev",3);
    //public static String f = "http://javarush.ru/testdata/big28data.html";
    int PAGE = 0;
            ...
            while (true)
            {
                ...
                for (Element element : elements)
                {
                    if (element != null)
                    {
                        ...
                        vac.setCompanyName(element.getElementsByAttributeValue("data-qa", "vacancy-serp__vacancy" +
                                "-employer").text());
